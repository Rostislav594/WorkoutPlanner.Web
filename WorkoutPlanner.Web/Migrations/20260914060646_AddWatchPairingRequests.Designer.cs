...
namespace WorkoutPlanner.Web.Migrations
{
    ...
    [Migration("20260914060646_AddWatchPairingRequests")]
    partial class AddWatchPairingRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutPlanner.Web.Models.PushDeviceRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WorkoutPlanner.Web.Models.SupportTicket", b =>
                {
                    ...
                    b.Property<string>("TelegramDeliveryStatus")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WorkoutPlanner.Web.Models.WatchPairingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("WatchPairingRequests", t =>
                        {
                            t.HasCheckConstraint("CK_WatchPairingRequests_Expiry", "[ExpiresAtUtc] > [CreatedAtUtc]");

                            t.HasCheckConstraint("CK_WatchPairingRequests_PollCount", "[PollCount] >= 0");
                        });
                });
